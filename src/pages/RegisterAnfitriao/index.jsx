...
const RegisterAnfitriao = () => {
  return (

    <div className="container">
        <div className="login-form">
            <div className="tittle">Registrar anfitrião</div>
            <form action="#">
                ...
                <div className="input-box">
                    <i className="fa fa-envelope"></i>
                    <input type="email" placeholder="Endereço residencial" required/>
                </div>
                <div className="input-box">
                    <i className="fa fa-envelope"></i>
...
export default RegisterAnfitriao